...
Introduction: State the problem (long coffee lines).

Design Proof: Show your UML diagrams first (proves you followed SE principles).
...
Conclusion: Show a snippet of your testing report to prove it’s "Fully Functional."
